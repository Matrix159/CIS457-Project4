...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        messageTextArea.setBackground(new Color(51, 51, 51));
        messageTextArea.setColumns(20);
        messageTextArea.setForeground(new Color(102, 255, 0));
        ...
        hostLabel.setForeground(new Color(255, 255, 0));
        ...
        fileLabel.setForeground(new Color(255, 255, 0));
        ...
        mp3Label.setBackground(new Color(255, 153, 0));
        ...
        mp3Label.setBorder(new javax.swing.border.LineBorder(new Color(238, 155, 60), 1, true));
        ...
        mp3Panel.setBackground(new Color(255, 0, 0));
            ...
            try {
                if (client.out != null) {
                    if (userList.getSelectedIndex() == 0) {
                        ...
                        if (messageField.getText().equalsIgnoreCase("/kick")) {
